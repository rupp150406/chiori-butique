...
<head>
    ...
    <!-- 
    primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦
    primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦
    primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦
    primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦
    primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦ primogems = ✦
   ...
   <link rel="stylesheet" type="text/css" href="{{ asset('css/animate.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset ('font/fonts.cs') }}">
                                            ...
                                            <li>
                                                <ul>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        ...
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="product-list.html" class="body-text">Chiori</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="mb-10">
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    <span class="body-title mb-2">Chiori</span>
